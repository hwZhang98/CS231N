...
import random
import svm                                # https://zhuanlan.zhihu.com/p/28247951
import numpy as np                        # https://blog.csdn.net/qq_41828351/article/details/90033531
import sys
...
#损失函数和梯度计算
w=np.random.randn(3072,10)*0.0001   #返回(3073,10)尺寸的符合正态分布的随机数组
loss,grad=svm.svm_loss_vectorized(w,x_dev,y_dev,0.00001)#也可使用公式计算梯度 svm_loss_vectorized
